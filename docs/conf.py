#!/usr/bin/env python
"""
ranked documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "ranked"))
...
project = "ranked"
_full_version = ranked.__version__
author = ranked.__author__
copyright = ranked.__copyright__
...
latex_documents = [
    (master_doc, "ranked.tex", "ranked Documentation", "authors", "manual"),
]
...
man_pages = [(master_doc, "ranked", "ranked Documentation", [author], 1)]
